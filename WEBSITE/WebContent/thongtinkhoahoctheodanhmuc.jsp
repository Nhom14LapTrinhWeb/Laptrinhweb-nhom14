		...
		<div class="col-md-9 col-sm-9 col-xs-9" id="Danhsachkhoahoc">
				<div class="row">
		            ...
		            <div class="col-md-9 col-sm-6 col-xs-6">
		                <h1>Danh sách khóa học theo mục</h1>
		            </div>
				...
				<%
					...
					String Loaikh="";
					if(request.getParameter("Loaikhoahoc")!=null)
					{
						Loaikh=Convert.toString(request.getParameter("Loaikhoahoc")) ;
					}
				%>
				
				<%
					for(khoahoc k: kh.getListKhoahocByLoaikhoahoc(Loaikh)){
				%>
