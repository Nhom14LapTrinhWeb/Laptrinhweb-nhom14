...
<%	User objUser = (User)session.getAttribute("userLogin"); 
	String query = "SELECT thamgia.Makhoahoc,tenkhoahoc,diemtong FROM khoahoc,thamgia WHERE tentaikhoan='"+objUser.getUsername()+"' and thamgia.makhoahoc=khoahoc.makhoahoc";
%> 
<sql:setDataSource
