...
<body>
	...
	<div class="panel panel-primary">
		<div class="panel-heading" style="text-align: center;" >DANH SÁCH ĐIỂM</div>
			<table class="table table-bordered" cellpadding="1" rules="all" border="1"   style="width:100%;border-collapse:collapse;" align="center">
				...
				<td style="width:5%;" align="center">STT</td>
					...
					<td style="width:20%;" align="center">Điểm trung bình</td>
					<td style="width:20%;" align="center">Chi chú</td>
		 ...
		 <button class="btn btn-warning pull-right">Nhập điểm</button>
			<button class="btn btn-warning pull-right">Sửa điểm</button>
